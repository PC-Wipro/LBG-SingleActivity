package com.lbg.project.presentation.ui.features.cats.view

import BottomNavigationScreens
...
import com.lbg.project.presentation.ui.theme.lightYellow
...
fun CatScreen(
    ...
    onNavigationRequested: (itemUrl: String, imageId: String,isfavCats:Boolean) -> Unit,
    onRefreshCall: () -> Unit
) {
        ...
        topBar = {
            CatAppBar(
                ...
                onNavigationIconClick = {
                    navigationSelectedItem = 0// Only show the button for the first segment {//top bar icon click call
    ...
    Surface(modifier = Modifier.semantics {
        ...
        Box {
            ...
            if (isFavCatsCall && cats.isEmpty()) {
                ...
                CatsList(cats = cats, isLoading = state.isLoading) { itemUrl, imageId ->
            ...
            this.items(cats) { item ->
                Card(
                    ...
                    modifier = Modifier
                        ...
                        .clickable {
                            Log.d("CatsListTest", "Card clicked")
                            if (!isLoading) {
