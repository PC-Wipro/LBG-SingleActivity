package com.lbg.project.presentation.ui.features.catDetails.view
...
import com.lbg.project.di.url
import com.lbg.project.presentation.ui.theme.ComposeSampleTheme
import com.lbg.project.presentation.ui.theme.favourite
import com.lbg.project.utils.TestTags
import com.lbg.project.utils.TestTags.BACK_NAVIGATION_ICON_DESCRIPTION
import com.lbg.project.utils.TestTags.FULL_SCREEN_APP_BAR
...
// Use derivedStateOf to derive isFavorite directly from isFavourite
    val derivedState = remember(isFavourite) {
        derivedStateOf { isFavourite }
    }

    LaunchedEffect(derivedState.value) {
        isFavorite = derivedState.value
    }
    IconToggleButton(
        checked = isFavorite,
        onCheckedChange = {
